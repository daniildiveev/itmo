...
class Main {
    public static void main(String [] args){
        ...
        output = output + z.getTheIdea(sphere) + sphere.getMaterial() + sphere.getMaterial();
        ...
        output = output + z.toString() + z.getTheIdea(ball) + z.getTheIdea(boots) + z.toString() + z.tell(b);
